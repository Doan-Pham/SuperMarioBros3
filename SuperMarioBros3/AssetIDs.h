...
#define ID_SPRITE_ITEM_POWERUP_MUSHROOM_LEAF (ID_SPRITE_ITEM_POWERUP + 300)
#define ID_SPRITE_ITEM_POWERUP_MUSHROOM_LEAF_MOVING_LEFT (ID_SPRITE_ITEM_POWERUP_MUSHROOM_LEAF + 10)
#define ID_SPRITE_ITEM_POWERUP_MUSHROOM_LEAF_MOVING_RIGHT (ID_SPRITE_ITEM_POWERUP_MUSHROOM_LEAF + 20)

#define ID_SPRITE_ITEM_POWERUP_MUSHROOM_FIREFLOWER (ID_SPRITE_ITEM_POWERUP + 400)
