...
#define OBJECT_TYPE_OVERWORLD_DECORATION	150
...
#define ID_SPRITE_PIPE_GREEN_HEAD_VERTICAL_UPSIDE (ID_SPRITE_PIPE_GREEN + 10)
#define ID_SPRITE_PIPE_GREEN_HEAD_VERTICAL_DOWNSIDE (ID_SPRITE_PIPE_GREEN + 20)
#define ID_SPRITE_PIPE_GREEN_BODY_VERTICAL (ID_SPRITE_PIPE_GREEN + 30)

#define ID_SPRITE_PIPE_BLACK (ID_SPRITE_PIPE + 200)
#define ID_SPRITE_PIPE_BLACK_HEAD_VERTICAL	(ID_SPRITE_PIPE_BLACK + 10)
#define ID_SPRITE_PIPE_BLACK_BODY_VERTICAL	(ID_SPRITE_PIPE_BLACK + 20)
...
#define ID_SPRITE_ENEMY_GOOMBA_BROWN_NORMAL_HIT_BY_DEADLY_ATTACKS (ID_SPRITE_ENEMY_GOOMBA_BROWN_NORMAL + 30)
...
#define ID_SPRITE_ENEMY_GOOMBA_RED_WING_HIT_BY_DEADLY_ATTACKS (ID_SPRITE_ENEMY_GOOMBA_RED_WING + 50)
...
#define ID_SPRITE_ENEMY_KOOPA_GREEN_WING_SHELL_SHAKE (ID_SPRITE_ENEMY_KOOPA_GREEN_WING + 70)
...
#define ID_SPRITE_ENEMY_KOOPA_RED_NORMAL_SHELL_SHAKE	(ID_SPRITE_ENEMY_KOOPA_RED_NORMAL + 50)
...
#define ID_SPRITE_MISC_INTRO_OVERWORLD			(ID_SPRITE_MISC + 4000)
#define ID_SPRITE_MISC_INTRO_CURTAIN		(ID_SPRITE_MISC_INTRO_OVERWORLD + 100)
#define ID_SPRITE_MISC_INTRO_TITLE			(ID_SPRITE_MISC_INTRO_OVERWORLD + 200)
#define ID_SPRITE_MISC_INTRO_TREE			(ID_SPRITE_MISC_INTRO_OVERWORLD + 300)
#define ID_SPRITE_MISC_INTRO_ARROW			(ID_SPRITE_MISC_INTRO_OVERWORLD + 400)

#define ID_SPRITE_MISC_OVERWORLD_DECORATION			(ID_SPRITE_MISC_INTRO_OVERWORLD + 500)
#define ID_SPRITE_MISC_OVERWORLD_DECORATION_WORLD_1	(ID_SPRITE_MISC_OVERWORLD_DECORATION + 10)
...
#define ID_SPRITE_MISC_SPECIAL_EFFECT_SCORES		(ID_SPRITE_MISC_SPECIAL_EFFECT + 400)
#define ID_SPRITE_MISC_SPECIAL_BRICK_GLASS_BROKEN	(ID_SPRITE_MISC_SPECIAL_EFFECT + 500)