...
#define ID_SPRITE_BRICK_QUESTIONMARK (ID_SPRITE_BRICK + 1000)
#define ID_SPRITE_BRICK_GLASS (ID_SPRITE_BRICK + 2000)
#define ID_SPRITE_BRICK_P_BLOCK (ID_SPRITE_BRICK + 3000)
...
#define ID_SPRITE_ITEMS 40000

#define ID_SPRITE_ITEMS_POWERUP (ID_SPRITE_ITEMS + 1000)
#define ID_SPRITE_ITEMS_POWERUP_MUSHROOM_BIG (ID_SPRITE_ITEMS_POWERUP + 100)
#define ID_SPRITE_ITEMS_POWERUP_MUSHROOM_1UP (ID_SPRITE_ITEMS_POWERUP + 200)
#define ID_SPRITE_ITEMS_POWERUP_MUSHROOM_LEAF (ID_SPRITE_ITEMS_POWERUP + 300)
#define ID_SPRITE_ITEMS_POWERUP_MUSHROOM_FIREFLOWER (ID_SPRITE_ITEMS_POWERUP + 400)

#define ID_SPRITE_ITEMS_ACHIEVEMENTS (ID_SPRITE_ITEMS + 4000)
#define ID_SPRITE_ITEMS_ACHIEVEMENTS_COINS (ID_SPRITE_ITEMS_OTHER + 100)

#pragma region ENEMIES

#define ID_SPRITE_ENEMIES 50000

#define ID_SPRITE_ENEMIES_GOOMBA (ID_SPRITE_ENEMIES + 1000)
#define ID_SPRITE_ENEMIES_GOOMBA_BROWN_NORMAL (ID_SPRITE_ENEMIES_GOOMBA + 100)
#define ID_SPRITE_ENEMIES_GOOMBA_BROWN_WING (ID_SPRITE_ENEMIES_GOOMBA + 200)
#define ID_SPRITE_ENEMIES_GOOMBA_RED_NORMAL (ID_SPRITE_ENEMIES_GOOMBA + 300)
#define ID_SPRITE_ENEMIES_GOOMBA_RED_WING (ID_SPRITE_ENEMIES_GOOMBA + 400)

#define ID_SPRITE_ENEMIES_KOOPA (ID_SPRITE_ENEMIES_ENEMIES + 2000)
#define ID_SPRITE_ENEMIES_KOOPA_GREEN_NORMAL (ID_SPRITE_ENEMIES_KOOPA + 100)
#define ID_SPRITE_ENEMIES_KOOPA_GREEN_WING (ID_SPRITE_ENEMIES_KOOPA + 200)
#define ID_SPRITE_ENEMIES_KOOPA_RED_NORMAL (ID_SPRITE_ENEMIES_KOOPA + 300)
#define ID_SPRITE_ENEMIES_KOOPA_RED_WING (ID_SPRITE_ENEMIES_KOOPA + 400)

#define ID_SPRITE_ENEMIES_PLANT (ID_SPRITE_ENEMIES_ENEMIES + 3000)
#define ID_SPRITE_ENEMIES_PLANT_RED_NORMAL (ID_SPRITE_ENEMIES_PLANT + 100)
#define ID_SPRITE_ENEMIES_PLANT_RED_FIRE (ID_SPRITE_ENEMIES_PLANT + 200)
#define ID_SPRITE_ENEMIES_PLANT_GREEN_NORMAL (ID_SPRITE_ENEMIES_PLANT + 300)
#define ID_SPRITE_ENEMIES_PLANT_GREEN_FIRE (ID_SPRITE_ENEMIES_PLANT + 400)
