...
#define KOOPA_STATE_HIT_BY_MARIO_TAIL					500
#define KOOPA_STATE_SHELL_STILL_UPSIDE					600
#define KOOPA_STATE_SHELL_MARIO_HOLD_UPSIDE				700
#define KOOPA_STATE_SHELL_MOVING_UPSIDE					800

#define KOOPA_STATE_HOPPING								900
#define KOOPA_STATE_DIE									1000

#define KOOPA_SHELL_TIMEOUT	6000
#define KOOPA_SHELL_SHAKE_TIME	(KOOPA_SHELL_TIMEOUT - 2000)
